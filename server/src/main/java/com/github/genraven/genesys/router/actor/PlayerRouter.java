...
//             @RouterOperation(path = CHARACTERISTICS, method = RequestMethod.PATCH, operation = @Operation(operationId = "updatePlayerCharacteristic", parameters = @Parameter(name = "id", in = ParameterIn.PATH), requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = CharacteristicUpdateRequest.class))), responses = @ApiResponse(responseCode = "204", description = "Characteristics updated"))),
