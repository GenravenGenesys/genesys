...
import type {Ability, ActorArmor, ActorTalent, ActorWeapon} from "../../../../api/model";
        ...
        <Card>
            ...
            <CardContent>
                <TabContext value={tab}>
                    ...
                    <TabPanel value="4">
                        <MinionAbilityTableCard minion={minion} abilities={minion.abilities} updateAbilities={handleAbilityChange} />
                    </TabPanel>
                    <TabPanel value="5">
