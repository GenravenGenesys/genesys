 ...
 */
export const getCareer = async (campaignId: string, options?: Parameters<typeof customFetch>[1]): Promise<getCareerResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCareerQueryKey(campaignId);
   ...
   return  { queryKey, queryFn, enabled: campaignId !== null && campaignId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCareer>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
