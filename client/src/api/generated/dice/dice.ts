 ...
 */
export const resolveChoices = async (resolveChoicesRequest: ResolveChoicesRequest, options?: RequestInit): Promise<resolveChoicesResponse> => {
 ...
 */
export const rollInitiative = async (initiativeRollRequest: InitiativeRollRequest, options?: RequestInit): Promise<rollInitiativeResponse> => {
 ...
 */
export const startEncounter = async (participant: Participant[], options?: RequestInit): Promise<startEncounterResponse> => {
 ...
 */
export const endEncounter = async ( options?: RequestInit): Promise<endEncounterResponse> => {
 ...
 */
export const executeRangedAttack = async (combatRollRequest: CombatRollRequest, options?: RequestInit): Promise<executeRangedAttackResponse> => {
 ...
 */
export const executeMeleeAttack = async (combatRollRequest: CombatRollRequest, options?: RequestInit): Promise<executeMeleeAttackResponse> => {
