 ...
 */
export const getArchetype = async (campaignId: string, options?: Parameters<typeof customFetch>[1]): Promise<getArchetypeResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetArchetypeQueryKey(campaignId);
   ...
   return  { queryKey, queryFn, enabled: campaignId !== null && campaignId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getArchetype>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
