...
export const getItems = (
 ...
 options?: SecondParameter<typeof customFetch>,signal?: AbortSignal
      ...
      return customFetch<ItemTemplate[]>(
      {url: `/api/campaigns/${campaignId}/compendium/items/`, method: 'GET', signal
    },
      options);
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetItemsQueryKey(campaignId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getItems>>> = ({ signal }) => getItems(campaignId, requestOptions, signal);
...
export const createItem = (
 ...
 options?: SecondParameter<typeof customFetch>,signal?: AbortSignal
      ...
      return customFetch<ItemTemplate>(
      {url: `/api/campaigns/${campaignId}/compendium/items/`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: itemTemplate, signal
    },
      options);
    }
...
export const deleteItem = (
 ...
 options?: SecondParameter<typeof customFetch>,) => {
      ...
      {url: `/api/campaigns/${campaignId}/compendium/items/${itemId}`, method: 'DELETE'
    },
      options);
    }
...
export const updateItem = (
 ...
 options?: SecondParameter<typeof customFetch>,) => {
      ...
      return customFetch<ItemTemplate>(
      {url: `/api/campaigns/${campaignId}/compendium/items/${itemId}`, method: 'PATCH',
      headers: {'Content-Type': 'application/json', },
      data: itemTemplate
    },
      options);
