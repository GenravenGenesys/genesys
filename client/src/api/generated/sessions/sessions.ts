...
return customFetch<createCampaignSessionResponse>(getCreateCampaignSessionUrl(),
  {
    ...
    body: JSON.stringify(campaignSession)
  }
);}
 ...
 */
export const getCampaignSession = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<getCampaignSessionResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCampaignSessionQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCampaignSession>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
 ...
 */
export const getAllCampaignSessions = async (campaignId: string, options?: Parameters<typeof customFetch>[1]): Promise<getAllCampaignSessionsResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllCampaignSessionsQueryKey(campaignId);
   ...
   return  { queryKey, queryFn, enabled: campaignId !== null && campaignId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllCampaignSessions>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
